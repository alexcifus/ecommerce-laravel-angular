...
class AuthController extends BaseController
{
    ...
    public function me()
    {
        ...
        return response()->json([
            ...
            'avatar' => $user->avatar ? env("APP_URL")."storage/".$user->avatar : 'https://cdn-icons-png.flaticon.com/512/6919/6919832.png',
        ]);
    }
    ...
    {
        // create a new token for the currently authenticated user instead of calling refresh()
        $user = auth('api')->user();
